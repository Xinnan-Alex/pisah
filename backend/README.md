...
Go API for the Pisah bill-splitter. Powers the owner iOS app and the friend web view.
...
- Owner image upload to Supabase Storage (iOS uploads directly; backend stores the URL)
